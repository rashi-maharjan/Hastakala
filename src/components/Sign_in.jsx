        ...
        <div className='place-self-center'>
          ...
          <div className='relative bg-white/20 max-sm:w-[300px] w-[470px] px-9 py-12 border-2 border-white rounded-xl'>
            <div >
              ...
              <input className='w-full border border-black rounded-3xl py-2 px-5 mt-4 outline-none' type="email" id="Email" />
            </div>
            <div className='mt-6'>
              <label htmlFor="password" className='font-inter text-base'>Password</label><br />
              <input className='w-full border border-black rounded-3xl py-2 px-5 mt-4 outline-none' type="password" id="password" />
            </div>
